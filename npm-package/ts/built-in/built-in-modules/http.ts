...
import {ESFunction, ESObject, ESPrimitive} from '../../runtime/primitiveTypes.js';
...
export default function (https: any, http: any, fs: any, mysql: any, context: Context, print: (...args: string[]) => void) {
    return {
