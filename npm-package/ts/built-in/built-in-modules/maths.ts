...
const module: JSModule = {
    ...
    abs: ({}, n) => {
        if (!(n instanceof ESNumber))
            return new TypeError(Position.unknown, 'number', str(n.typeOf()), str(n));
    ...
    atan2: ({}, y, x) => {
        ...
        return new TypeError(Position.unknown, 'number', str(x.typeOf()), str(x));
        if (!(y instanceof ESNumber))
            return new TypeError(Position.unknown, 'number', str(y.typeOf()), str(y));
    ...
    randInt: ({}, min, max) => {
        if (!(min instanceof ESNumber))
            return new TypeError(Position.unknown, 'number', str(min.typeOf()), str(min));
        if (!(max instanceof ESNumber))
            return new TypeError(Position.unknown, 'number', str(max.typeOf()), str(max));
