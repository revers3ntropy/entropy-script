 ...
 */
export function createInstance (type: ESType, {context}: {context: Context}, params: Primitive[], runInit=true, on: dict<Primitive> = {}) {
    ...
    // @ts-ignore
    on['constructor'] = type.__init__?.clone() ?? new ESUndefined();
